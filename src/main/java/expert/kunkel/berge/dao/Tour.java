...
public class Tour implements java.io.Serializable, Comparable<Tour> {
    ...
    public void setKarten(Object[] karten) {
        ...
        for (int i = 0; i < karten.length; i++) {
            this.karten.add((Karte) karten[i]);
        }
    }
    ...
    public List<Tourentag> getTourentage() throws SQLException, ClassNotFoundException {
    ...
    public String getZeitraumAsHtml() throws SQLException, ClassNotFoundException {
	...
	public boolean hasCompleteTourenabschnitte() throws ClassNotFoundException, SQLException {
