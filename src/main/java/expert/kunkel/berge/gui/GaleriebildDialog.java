...
import expert.kunkel.berge.dao.jpa.GaleriebildDao;
...
public class GaleriebildDialog extends javax.swing.JDialog {
	...
	public GaleriebildDialog(java.awt.Frame parent, Tour tour) {
		...
		bildTable.getColumn(bildTableModel.getColumnName(0)).setPreferredWidth(
				100);
		bildTable.getColumn(bildTableModel.getColumnName(1)).setPreferredWidth(
				300);
		bildTable.getColumn(bildTableModel.getColumnName(2)).setPreferredWidth(
				40);
		bildTable.getColumn(bildTableModel.getColumnName(3)).setPreferredWidth(
				40);
	...
	public static void main(String args[]) {
		java.awt.EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				...
				Tour tour = tourDao.findById(106);

				GaleriebildDialog dialog = new GaleriebildDialog(
						new javax.swing.JFrame(), tour);
	...
	private void reloadGaleriebilder() {
		bildTableModel.setData(factory.getGaleriebildDAO().selectGaleriebild(
				tour));
	}
}
