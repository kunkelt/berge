...
public class TourentagDialog extends javax.swing.JDialog {
	...
	public TourentagDialog(java.awt.Frame parent, Tourentag ttag) {
		...
		if (ttag == null) {
			JOptionPane.showMessageDialog(this,
					"Erzeugen eines neuen Tourentages ist hier nicht erlaubt!",
	...
	private void bAbschnitteActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_bAbschnitteActionPerformed
		TourenabschnittDialog taDialog = new TourenabschnittDialog(
	...
	public static void main(String args[]) {
		java.awt.EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				...
				dialog = new TourentagDialog(new javax.swing.JFrame(), tour
						.getTourentage().get(0));
	...
	private void setData(Tourentag ttag) throws SQLException,
			ClassNotFoundException {
		this.ttag = ttag;

		if (ttag != null) {
			tfDatum.setText(sdf.format(ttag.getDatum()));
			...
			tfSchwierig.setText(ttag.getSchwierigkt());
			...
			tfBildtitel.setText(ttag.getBildtitel());
		}
	}
}
